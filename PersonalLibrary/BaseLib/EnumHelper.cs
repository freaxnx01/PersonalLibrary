...
namespace Library
{
    ...
    {
        #region BindEnumToListBox
        public static void BindEnumToListBox(Type enumType, ListBox listBox)
        {
            // Beispiel Verwendung
            /*
                   private void ShowEnvVariables()
                   {
                       ...
                       EnumHelper.BindEnumToListBox(typeof(EnvironmentVariableTarget), listBox1);
                   }

                   private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
                   {
                       ShowEnvVariablesByTarget((EnvironmentVariableTarget)((ListBox)sender).SelectedValue);
                   } 
            ...
            */
            ...
            listBox.DataSource = EnumHelper.TransformEnumToList(enumType);
        }
        #endregion
